...
produces="PRODUCES: verification level + ASVS checklist per asvs-verification plugin; CWE-tagged, CVSS-scored finding list per cwe-cvss-findings plugin; scope-covered summary"
